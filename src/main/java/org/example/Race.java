...
public class Race {
    ...
    public void printResults() {
        ...
        for (F1Cars participant : participantCars) {
            log.info("Позиция: {} болид: {} время: {}", position++, participant.getId(), participant.getTime());
        }
    }
}
